        ...
        html! {
            <div class="flex w-screen bg-gray-900 text-white">
                <div class="flex-none w-56 h-screen bg-gray-100">
                    <div class="text-xl text-gray-500 p-3">{"Users"}</div>
                    {
                        self.users.clone().iter().map(|u| {
                            html!{
                                <div class="flex m-3 bg-gray-700 rounded-lg p-2 border border-gray-600">
                                    <div>
                ...
                <div class="grow h-screen flex flex-col">
                    <div class="w-full h-14 border-b-2 border-gray-300"><div class="text-xl p-3">{"💬 Hubungi Temanmu!"}</div></div>
                    <div class="w-full grow overflow-auto border-b-2 border-gray-700">
                        {
                            self.messages.iter().map(|m| {
                                let user = self.users.iter().find(|u| u.name == m.from).unwrap();
                                html!{
                                    <div class="flex items-end w-3/6 bg-gray-100 m-8 rounded-tl-lg rounded-tr-lg rounded-br-lg border border-gray-600">
